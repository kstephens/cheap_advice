...
* Cheap Advice adds dynamic Advice to Ruby methods.
* Cheap Advice is applied methods.
* Cheap Advice are stateful objects.
* Cheap Advice can be added and removed at run-time.
